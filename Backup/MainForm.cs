...
namespace DeviceManagement
{
  public class MainForm : Form
  {
    ...
    {
      if (this.InvokeRequired)
        this.Invoke((Delegate) new MainForm.SetProVisibleDele(this.SetProVisible), (object) (bool) (visible ? 1 : 0));
      else
    ...
    private void SetMessage(string message, string oldMessage, bool isClear)
    {
      if (this.InvokeRequired)
      {
        this.Invoke((Delegate) new MainForm.SetMessageDele(this.SetMessage), (object) message, (object) oldMessage, (object) (bool) (isClear ? 1 : 0));
      }
      else
      {
