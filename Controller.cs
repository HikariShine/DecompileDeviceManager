        ...
        if (response.OptionList != null)
        {
          foreach (OptionClass optionClass in response.OptionList)
          {
            try
            {
              ...
              else
              {
                if (device == null)
                {
                  ...
                  // ISSUE: explicit reference operation
                  // ^local = str;
                  message = message + optionClass.PropertyName.ToString() + " Error: " + Message.SystemError + "\r";
                  return false;
                }
            ...
            catch (Exception ex)
            {
              ...
              // ISSUE: explicit reference operation
              // ^local = str;
              message  = message + optionClass.PropertyName.ToString() + " Error: " + ex.Message + "\r";
            }
          }
        }
      }
