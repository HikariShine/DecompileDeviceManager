...
### 问题描述
软件截图：![上位机软件截图.png](https://note.youdao.com/yws/api/personal/file/973B7E68CBA24A43AF74DE49A6393EA5?method=download&shareKey=b91a41f4bfc698c985ba237e76791bb3)
...
那么就是只支持广播方式连接设备？感觉不太可能，但是目前只能查到这里，直到发现了一个特殊的设备...

#### 发现可远程连接的设备，对其进行抓包分析

在尝试过程中，竟然发现了一个可以远程连接的设备，赶紧对其进行抓包分析：
